...
[I was told that there are 2 aspects of web development, the front end and the back end. To my knowledge, JavaScript is a programming language used for the front end part of web development and python is a programming language used for the back end]
